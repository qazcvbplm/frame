...
public class WeChatPayUtil  {
	 ...
	 * @throws Exception 
	 */
	public static String transfers(HttpServletRequest request,App app,String payId,BigDecimal amount,String openId) throws Exception{
		String[] uiids = null;
		...
		List<Map<String, String>> list =  new ArrayList<>();
			...
			parms.put("mch_appid", app.getAppid());//企业公众号appid
			parms.put("mchid", app.getMch_id());//微信支付分配的商户号
